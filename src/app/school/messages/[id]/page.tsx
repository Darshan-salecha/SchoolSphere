...
export default async function SchoolThreadPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
      <Link href="/school/messages" className="mb-4 inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-900">
